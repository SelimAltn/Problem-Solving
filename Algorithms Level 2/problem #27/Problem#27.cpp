...
void PrintMatrisinSayilariOrtalamasi(int arry[100], int boyut)
{
    int Toplam = 0;
    for (int i = 0; i < boyut; i++)
    {
    ...
    cout << "Sayilarin Ortalamasi  : " << (float)Toplam/boyut << endl;
}
int main()
{
    int Arry[100];
    ...
    PrintMatrisinSayilariOrtalamasi(Arry, ArrySize);
    return 0;
